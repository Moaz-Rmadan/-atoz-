...
let mockRides: Ride[] = [
  {
    ...
    pickup_address_text: 'مزلقان الانشاء والتعمير، كفر الشيخ',
    pickup_latitude: 31.111,
    pickup_longitude: 30.942,
    dropoff_address_text: 'كلية الحاسبات والمعلومات، جامعة كفر الشيخ',
    dropoff_latitude: 31.098,
    dropoff_longitude: 30.944,
    estimated_fare: 25,
    final_fare: 25,
    status: 'completed',
