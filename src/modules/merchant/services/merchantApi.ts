...
let localProducts: Product[] = [
  {
    ...
    description_ar: 'أرز كفراوي درجة أولى مصفى ومعبأ بعناية فائقة.',
    price: 32,
    stock_quantity: 150,
    is_active: true,
  ...
  },
  {
    ...
    merchant_id: 'merch-test-id',
    category_id: 'pcat-2',
    title_ar: 'وجبة كبسة دجاج كفراوي',
      ...
      return localMerchant ? [localMerchant] : [
        {
          ...
          bio: 'المتجر الرسمي لتوفير المواد الغذائية والتموينية بأسعار مميزة لأهالي كفر البطيخ ودمياط.',
          store_logo_url: null,
